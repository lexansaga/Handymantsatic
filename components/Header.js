...
export default function Header({
  ...
  return (
    <View style={styles.HeaderContainer}>
      <TouchableOpacity
        onPress={onPress != null ? onPress : () => sideNavigation.openDrawer()}
      >
        <Feather name="menu" size={25} color="#000" style={styles.Navbutton} />
      </TouchableOpacity>
        ...
        <>
          ...
          >
            ...
            >
              <Image
                source={{
                  uri: IsNullOrEmpty(userProfile) ? profile : userProfile,
                }}
                style={styles.Avatar}
              />
            </TouchableOpacity>
